...
Purpose:
    ...
    Data Source: JRA55 (fcst_phy2m & fcst_surf)
       ...
       Record of revision:
           ...
           2018/10/05      Abdul Moiz      Code was parallelized over months
'''
#==============================================================================
...
#------------------------------------------------------------------------------
def proc_jra55(month,sel_year,year,project,data,output,variable,mapping,netcdf,x,y,xi,yi,whseds_mask):
...
parameter = 'parameter'
mapping = 'mapping'
jra55_folder = os.path.join(project,inputs,'ren_jra55','slevel')
netcdf = 'jra55_nc'
    ...
    for variable in variables:
        ...
        for year in years:
            ...
            pool.map(partial(proc_jra55,
                             ...
                             xi=xi,
                             yi=yi,
                             whseds_mask=wsheds_mask), months)
